...
COUNTER=0
for file in EUR_intermediate_chr3.null.y.glm.linear EUR_intermediate_chr1.null.y.glm.linear EUR_intermediate_chr4.null.y.glm.linear EUR_intermediate_chr6.null.y.glm.linear EUR_intermediate_chr2.null.y.glm.linear EUR_intermediate_chr5.null.y.glm.linear
do
  COUNTER=$((COUNTER+1))
  if [[ $COUNTER -eq 1 ]]
  then
