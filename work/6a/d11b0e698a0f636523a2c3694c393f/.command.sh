...
echo EUR_affected_y
COUNTER=0
for file in EUR_affected_chr3.null.y.glm.linear EUR_affected_chr4.null.y.glm.linear EUR_affected_chr2.null.y.glm.linear EUR_affected_chr6.null.y.glm.linear EUR_affected_chr1.null.y.glm.linear EUR_affected_chr5.null.y.glm.linear
do
  COUNTER=$((COUNTER+1))
  if [[ $COUNTER -eq 1 ]]
  then
